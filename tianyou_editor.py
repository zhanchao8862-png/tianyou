...
class TianyouEditor(object):
    ...
    def _pretty_imodbits_label(self, name):
        mapping = {
            'imodbits_horse_basic': u'基础马匹',
            'imodbits_cloth': u'布衣',
            'imodbits_armor': u'护甲',
            'imodbits_plate': u'板甲',
            'imodbits_polearm': u'长杆',
            'imodbits_shield': u'盾牌',
            'imodbits_sword': u'剑类',
            'imodbits_sword_high': u'高级剑类',
            'imodbits_axe': u'斧类',
            'imodbits_mace': u'锤类',
            'imodbits_pick': u'钉锤',
            'imodbits_bow': u'弓类',
            'imodbits_crossbow': u'弩类',
            'imodbits_missile': u'投射武器',
            'imodbits_thrown': u'投掷武器',
            'imodbits_thrown_minus_heavy': u'轻型投掷武器',
            'imodbits_horse_good': u'优良马匹',
            'imodbits_good': u'优质',
            'imodbits_bad': u'低质',
        }
