...
class TianyouEditor(object):
    ...
    def _build_item_detail_panel(self, parent):
        """Build scrollable item detail form panel."""
        ...
        s1.pack(fill='x', padx=5, pady=3)
        for ri, (rk, rl) in enumerate([
            ('id', u'ID'), ('name', u'\u540d\u79f0'),
            ('capabilities', u'\u80fd\u529b (Capabilities)'), ('value', u'\u4ef7\u503c (Value)')
        ]):
            tk.Label(s1, text=rl + ':', anchor='e', width=14).grid(row=ri, column=0, sticky='e', padx=(5, 0), pady=2)
            var = tk.StringVar()
            tk.Entry(s1, textvariable=var, width=45).grid(row=ri, column=1, sticky='w', padx=2, pady=2)
            self._item_detail_vars[rk] = var

        # Section 2: Meshes
        s2 = tk.LabelFrame(f, text=u'\u6a21\u578b (Meshes)', font=('', 10, 'bold'))
        s2.pack(fill='x', padx=5, pady=3)
        for ri, (rk, rl) in enumerate([
            ('mesh_name', u'\u6a21\u578b\u540d\u79f0'), ('mesh_flag', u'\u6a21\u578b\u6807\u5fd7'), ('mesh_action', u'\u52a8\u4f5c (Action)')
        ]):
            tk.Label(s2, text=rl + ':', anchor='e', width=14).grid(row=ri, column=0, sticky='e', padx=(5, 0), pady=2)
            var = tk.StringVar()
            tk.Entry(s2, textvariable=var, width=45).grid(row=ri, column=1, sticky='w', padx=2, pady=2)
            self._item_detail_vars[rk] = var

        # Section 3: Type flags (18 checkboxes, 6 cols)
        s3 = tk.LabelFrame(f, text=u'\u7c7b\u578b\u6807\u8bb0 (Type Flags)', font=('', 10, 'bold'))
        s3.pack(fill='x', padx=5, pady=3)
        type_flags = [
            (u'itp_type_horse', u'\u9a6c horse'),
            (u'itp_type_one_handed_wpn', u'\u5355\u624b\u6b66\u5668 1h'),
            (u'itp_type_two_handed_wpn', u'\u53cc\u624b\u6b66\u5668 2h'),
            (u'itp_type_polearm', u'\u957f\u6746 polearm'),
            (u'itp_type_arrows', u'\u7bad arrows'),
            (u'itp_type_bolts', u'\u5f29\u77e2 bolts'),
            (u'itp_type_shield', u'\u76fe shield'),
            (u'itp_type_bow', u'\u5f13 bow'),
            (u'itp_type_crossbow', u'\u5f29 crossbow'),
            (u'itp_type_thrown', u'\u6295\u63b7 thrown'),
            (u'itp_type_goods', u'\u5546\u54c1 goods'),
            (u'itp_type_head_armor', u'\u5934\u76d4 head'),
            (u'itp_type_body_armor', u'\u8eab\u4f53 body'),
            (u'itp_type_foot_armor', u'\u978b foot'),
            (u'itp_type_hand_armor', u'\u624b\u5957 hand'),
            (u'itp_type_pistol', u'\u624b\u67aa pistol'),
            (u'itp_type_musket', u'\u706b\u67aa musket'),
            (u'itp_type_bullets', u'\u5b50\u5f39 bullets'),
        ]
        ...
        # Section 4: Stats (19 Entries, 2 cols)
        s4 = tk.LabelFrame(f, text=u'\u6570\u503c\u5c5e\u6027 (Stats)', font=('', 10, 'bold'))
        s4.pack(fill='x', padx=5, pady=3)
        stat_fields = [
            (u'weight', u'\u91cd\u91cf weight'),
            (u'difficulty', u'\u96be\u5ea6 difficulty'),
            (u'spd_rtng', u'\u901f\u5ea6 spd_rtng'),
            (u'weapon_length', u'\u957f\u5ea6 length'),
            (u'swing_damage', u'\u6325\u780d damage'),
            (u'thrust_damage', u'\u523a\u51fb damage'),
            (u'max_ammo', u'\u6700\u5927\u5f39\u836f ammo'),
            (u'speed_rating', u'\u901f\u5ea6 rating'),
            (u'shoot_speed', u'\u5c04\u901f shoot_speed'),
            (u'horse_speed', u'\u9a6c\u901f horse_speed'),
            (u'horse_maneuver', u'\u9a6c\u64cd\u63a7 maneuver'),
            (u'horse_charge', u'\u9a6c\u51b2\u51fb charge'),
            (u'horse_scale', u'\u9a6c\u5c3a\u5bf8 scale'),
            (u'accuracy', u'\u7cbe\u51c6 accuracy'),
            (u'body_armor', u'\u8eab\u4f53 armr'),
            (u'head_armor', u'\u5934\u76d4 armr'),
            (u'leg_armor', u'\u817f\u90e8 armr'),
            (u'abundance', u'\u4e30\u5ea6 abundance'),
            (u'armor', u'\u62a4\u7532 armor'),
        ]
        self._item_detail_stat_vars = {}
        for si, (sk, sl) in enumerate(stat_fields):
            row = si // 2
            col = (si % 2) * 2
            tk.Label(s4, text=sl + ':', anchor='e', width=14).grid(row=row, column=col, sticky='e', padx=(5, 0), pady=1)
            var = tk.StringVar()
            tk.Entry(s4, textvariable=var, width=18).grid(row=row, column=col + 1, sticky='w', padx=2, pady=1)
            self._item_detail_stat_vars[sk] = var

        # Section 5: Other flags (32 checkboxes, 6 cols)
        s5 = tk.LabelFrame(f, text=u'\u5176\u4ed6\u6807\u8bb0 (Other Flags)', font=('', 10, 'bold'))
        s5.pack(fill='x', padx=5, pady=3)
        other_flags = [
            (u'itp_merchandise', u'\u5e97\u54c1 merchandise'),
            (u'itp_wooden_attack', u'\u6728\u5236 wood_attk'),
            (u'itp_wooden_parry', u'\u6728\u5236 wood_parry'),
            (u'itp_wooden_weapon', u'\u6728\u5236 wood_wpn'),
            (u'itp_cant_reload_on_horseback', u'\u9a6c\u4e0a\u65e0\u6cd5\u88c5\u586b no_reload'),
            (u'itp_two_handed', u'\u53cc\u624b 2h'),
            (u'itp_primary', u'\u4e3b\u6b66\u5668 primary'),
            (u'itp_secondary', u'\u526f\u6b66\u5668 secondary'),
            (u'itp_covers_legs', u'\u906e\u6321\u817f\u90e8 covers_legs'),
            (u'itp_doesnt_cover_hair', u'\u4e0d\u906e\u5934\u53d1 no_hair'),
            (u'itp_can_penetrate_shield', u'\u53ef\u7a7f\u76fe penetrate'),
            (u'itp_civilian', u'\u5e73\u6c11 civilian'),
            (u'itp_next_item_as_melee', u'\u4e0b\u6b65\u8fd1\u6218 melee_next'),
            (u'itp_is_pike', u'\u957f\u67aa pike'),
            (u'itp_cant_use_on_horseback', u'\u9a91\u5175\u7981\u7528 no_horse'),
            (u'itp_no_parry', u'\u65e0\u62db\u67b6 no_parry'),
            (u'itp_default_ammo', u'\u9ed8\u8ba4\u5f39\u836f def_ammo'),
            (u'itp_has_upper_stab', u'\u4e0a\u523a upper_stab'),
            (u'itp_extra_penetration_flag', u'\u989d\u5916\u7a7f\u900f extra_pen'),
            (u'itp_has_lower_stab', u'\u4e0b\u523a lower_stab'),
            (u'itp_bonus_against_shield', u'\u7834\u76fe bonus_shield'),
            (u'itp_extra_penetration', u'\u7a7f\u900f extra_pen'),
            (u'itp_consumable', u'\u6d88\u8017\u54c1 consumable'),
            (u'itp_couchable', u'\u5e73\u6301\u957f\u67aa couchable'),
            (u'itp_crush_through', u'\u51b2\u7834 crush_through'),
            (u'itp_remove_item_on_use', u'\u4f7f\u7528\u540e\u4e22\u5f03 remove_on_use'),
            (u'itp_no_pick_up_from_ground', u'\u4e0d\u53ef\u62fe\u8d70 no_pickup'),
            (u'itp_can_knock_down', u'\u53ef\u51fb\u5012 knock_down'),
            (u'itp_fit_to_head', u'\u9002\u914d\u5934\u90e8 fit_head'),
            (u'itp_force_attach_left_hand', u'\u5f3a\u5236\u5de6\u624b force_L'),
            (u'itp_force_attach_right_hand', u'\u5f3a\u5236\u53f3\u624b force_R'),
            (u'itp_force_show_body', u'\u663e\u793a\u8eab\u4f53 show_body'),
            (u'itp_force_show_left_hand', u'\u663e\u793a\u5de6\u624b show_L'),
            (u'itp_force_show_right_hand', u'\u663e\u793a\u53f3\u624b show_R'),
            (u'itp_no_blur', u'\u65e0\u6a21\u7cca no_blur'),
        ]
        ...
        # Section 6: Modifier bits
        s6 = tk.LabelFrame(f, text=u'\u4fee\u9970\u7b26 (Modifier Bits)', font=('', 10, 'bold'))
        s6.pack(fill='x', padx=5, pady=3)
        imod_presets = [
        ...
        s7 = tk.LabelFrame(f, text=u'\u89e6\u53d1\u5668 & \u9635\u8425 (Triggers & Factions)', font=('', 10, 'bold'))
        s7.pack(fill='x', padx=5, pady=3)
        tk.Label(s7, text=u'Triggers:', anchor='ne', width=10).grid(row=0, column=0, sticky='ne', padx=(5, 0), pady=2)
        self._item_detail_vars['triggers'] = tk.StringVar()
        tk.Entry(s7, textvariable=self._item_detail_vars['triggers'], width=60).grid(row=0, column=1, columnspan=3, sticky='w', padx=2, pady=2)
        tk.Label(s7, text=u'Factions:', anchor='ne', width=10).grid(row=1, column=0, sticky='ne', padx=(5, 0), pady=2)
        self._item_detail_vars['factions'] = tk.StringVar()
        tk.Entry(s7, textvariable=self._item_detail_vars['factions'], width=60).grid(row=1, column=1, columnspan=3, sticky='w', padx=2, pady=2)
    ...
    def _populate_item_detail(self, flds):
        ...
        if stats_expr:
            ...
            while raw_stats:
                ...
                if raw_stats.startswith('|'):
                    raw_stats = raw_stats[1:]
        for sk, var in self._item_detail_stat_vars.items():
            var.set(stats.get(sk, ''))
